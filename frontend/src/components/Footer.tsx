...
const Footer = () => {
  ...
  return (
    <motion.footer
      ...
      className="bg-sage-900 text-white section-padding mt-20"
    >
      <div className="page-container">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            <h3 className="text-xl font-serif font-light mb-4">Poppy Larbalestier Photography</h3>
          ...
          <div className="text-center md:text-right">
            ...
            <p className="text-sage-300 text-sm">
              © {currentYear} Poppy Larbalestier Photography. All rights reserved.
            </p>
          </div>
        </div>
      </div>
