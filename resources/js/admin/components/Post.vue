    ...
    <div class="card">
        ...
        <ul class="nav nav-tabs card-header-tabs">
          <li class="nav-item">
            <a
              ...
              href="#"
              @click.prevent="changeTabTo('main')"
              >Main</a
            >
          </li>
          <li class="nav-item" v-if="post.id">
            <a
              ...
              href="#"
              @click.prevent="changeTabTo('images')"
              >Images</a
            >
          </li>
        </ul>
      ...
      <div class="card-body" v-else-if="post.id && tab === 'images'">
        <div class="form-group">
          ...
          <image-uploader
            :multiple="true"
            @change="assignImages(post, $event)"
            :url="`/api/admin/posts/${post.id}/images`"
            class="form-group"
          ></image-uploader>
          <div
            v-if="post.hasOwnProperty('images') && post.images.length"
            class="form-group"
          >
                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    >
                      <span
                        aria-hidden="true"
                        @click.prevent="deleteImage(post, image, index)"
                        >&times;</span
                      >
                    </button>
                  </div>
                  <div class="card-body">
                    ...
                    >
                      <div
                        ...
                        :style="`background-image: url(${image.path}); background-position: center; background-size: cover; background-repeat: no-repeat;`"
                        :title="image.name"
                      ></div>
                    </div>
                  </div>
...
export default {
  ...
  mixins: [ErrorsAndProcessing, ProcessIfNotProcessing, ManageImages, Tabs],
  data() {
    return {
      post: {
        title: undefined,
